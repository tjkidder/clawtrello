...
If you hit merge markers like `<<<<<<<`, `=======`, `>>>>>>>` in:
- `README.md`
- `public/index.html`
- `src/openclawConfig.ts`
...
If it fails, keep the versions currently in this branch and remove all conflict markers, then rerun the check until it passes.
